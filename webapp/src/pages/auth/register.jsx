        ...
        <div className="max-w-200 bg-white rounded-[5px] shadow-[0_3px_6px_rgba(0,0,0,0.16)] sm:mt-15 relative">
          ...
          <div className="flex flex-col p-6">
            ...
            <Form
              ...
              className="auth-form"
              onFinishFailed={() =>
                message.error(t("Some fields are missing"))
              }>
                  ...
                  <Form.Item
                    ...
                    rules={[
                      {
                        ...
                        validator: async (_, checked) => {
                          if (!checked) {
                            return Promise.reject(
                              new Error(
                                t("You must accept our privacy policy."),
                              ),
                            );
                          }
                        },
                    ...
                    <Checkbox size="large">
                      <p className="text-[#707070] text-[12px]">
                        {t(
                          "I declare that I have read the Privacy Policy of this site, as well as its Terms of Use.",
                        )}
                      </p>
                    </Checkbox>
                  </Form.Item>
