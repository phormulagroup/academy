		...
		<div className="container mx-auto p-6 flex flex-col justify-start items-center mt-10">
			...
			{isLoading ? (
				...
				<div className="grid grid-cols-1 lg:grid-cols-4 gap-4 w-full">
					{data.map((d) => (
						<Link
							className="flex flex-col shadow-[0px_3px_6px_#00000029] rounded-[5px] cursor-pointer"
							to={`/${i18n.language}/downloads/${d.slug}`}
						>
							<div
								className="bg-center bg-cover h-50 w-full rounded-t-[5px]"
								style={{
							...
							<div className="p-6 min-h-30 flex justify-center items-center bg-[#C5CEE1]">
								<p className="text-lg font-semibold text-[#163986] text-center">
									{d.name}
								</p>
							</div>
